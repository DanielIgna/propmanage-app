...
const TOPICS = [
  ...
  },
  {
    ...
    content: [
      ...
      { h: "Dashboard → 'Reset la valori implicite'", p: "Resetează TOATE setările la valorile din cod (2.400 RON audit, 15.000 RON twin, 0% comision). Folosește DOAR dacă cineva a stricat configurarea și nu mai funcționează nimic. NU folosi la întâmplare — vei pierde link-urile sociale și setările SEO." },
